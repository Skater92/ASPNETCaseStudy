...
INSERT INTO Products (Id, BrandId, Timer, ProductName, GraphicName, CostPrice, MSRP, QtyOnHand, QtyOnBackOrder, Description)
VALUES ('6',  4, 0x31, 'Kraken V3', 'Kraken_V3.jpeg', 2.50, 49.99, 0, 100, 'A PC gaming headset powered by Razer Chroma(tm) RGB, armed with advanced 7.1 surround sound for realistic positional audio.');

INSERT INTO Products (Id, BrandId, Timer, ProductName, GraphicName, CostPrice, MSRP, QtyOnHand, QtyOnBackOrder, Description)
VALUES ('7',  4, 0x31, 'BlackShark V2 X', 'BlkShk_V2_X.jpeg', 2.50, 82.99, 23, 10, 'The gaming headset thats approved by pro gamers featuring TriForce 50mm drivers, HyperClear Cardioid Mic, and advanced passive noise cancellation.');

INSERT INTO Products (Id, BrandId, Timer, ProductName, GraphicName, CostPrice, MSRP, QtyOnHand, QtyOnBackOrder, Description)
VALUES ('8',  4, 0x31, 'Kraken Kitty', 'Kraken_Kitty.jpeg', 33.50, 139.99, 0, 100, 'Create the purrfect gaming look with your own killer kitty style. Express your own unique personality and passion in the most colorful way imaginable with the Razer Kraken Kitty Edition—a USB gaming headset with highly customizable lighting thats every shade of awesome.');

INSERT INTO Products (Id, BrandId, Timer, ProductName, GraphicName, CostPrice, MSRP, QtyOnHand, QtyOnBackOrder, Description)
VALUES ('9',  4, 0x31, 'Kaira Pro', 'Kaira_Pro.jpeg', 22.50, 133.99, 0, 100, 'Enjoy cutting-edge audio performance that embraces the future of Xbox. Enter the Razer Kaira Pro—a wireless headset for Xbox Series X|S and mobile gaming.');

INSERT INTO Products (Id, BrandId, Timer, ProductName, GraphicName, CostPrice, MSRP, QtyOnHand, QtyOnBackOrder, Description)
VALUES ('10', 4, 0x31, 'Kraken BT-Hello Kitty', 'Kraken_BTHello_Kitty.jpeg', 15.99, 151.99, 0, 100, 'Come along with Hello Kitty and Friends this holiday as they embark on an extraordinary journey to a place where limits are exceeded, epic plays are celebrated, and friendships are cherished above all else. Experience this adventure with exciting Razer gear as you share unforgettable moments and winning smiles with each other—because as Hello Kitty always says, “You can never have too many friends”, or wins.');
